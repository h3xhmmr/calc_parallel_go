...
type CalculatorServiceClient interface {
	GetTask(ctx context.Context, in *Get_TaskReq, opts ...grpc.CallOption) (*Get_TaskResp, error)
	SaveTaskResult(ctx context.Context, in *SaveTaskResReq, opts ...grpc.CallOption) (*SaveTaskResultResponse, error)
}
...
func (c *calculatorServiceClient) GetTask(ctx context.Context, in *Get_TaskReq, opts ...grpc.CallOption) (*Get_TaskResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Get_TaskResp)
...
func (c *calculatorServiceClient) SaveTaskResult(ctx context.Context, in *SaveTaskResReq, opts ...grpc.CallOption) (*SaveTaskResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CalculatorServiceServer interface {
	GetTask(context.Context, *Get_TaskReq) (*Get_TaskResp, error)
	SaveTaskResult(context.Context, *SaveTaskResReq) (*SaveTaskResultResponse, error)
...
func (UnimplementedCalculatorServiceServer) GetTask(context.Context, *Get_TaskReq) (*Get_TaskResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTask not implemented")
}
func (UnimplementedCalculatorServiceServer) SaveTaskResult(context.Context, *SaveTaskResReq) (*SaveTaskResultResponse, error) {
...
func _CalculatorService_GetTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).GetTask(ctx, req.(*Get_TaskReq))
	}
...
func _CalculatorService_SaveTaskResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).SaveTaskResult(ctx, req.(*SaveTaskResReq))
	}
	return interceptor(ctx, in, info, handler)
}
